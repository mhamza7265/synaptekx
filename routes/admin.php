...
Route::group(['middleware' => ['role:admin,superadmin']], function () {
    ...
    Route::delete('/home-page/client/delete/{index}', [HomePageContentController::class, 'deleteClient'])->name('home-page.client.delete');
    ...
    Route::post('/partners-page/section-scaled-save', [PartnersPageContentController::class, 'updateScaledPartners'])->name('partners-page.scaled-partners.update');
    ...
    Route::post('/partners-page/section-all-save', [PartnersPageContentController::class, 'updateAllPartners'])->name('partners-page.all-partners.update');
