        ...
        <div class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area icon-accordion-content">
                    <h3 class="text-center pb-2">Edit Privacy Policy Page</h3>
                    <div id="withoutSpacing" class="no-outer-spacing accordion">
                        ...
                        <div class="card mt-2">
                            ...
                            <div id="withoutSpacingAccordionMeta" class="collapse" aria-labelledby="headingMeta2" data-bs-parent="#withoutSpacing">
                                <form method="post" action="{{ route('admin.legal.hero.update', ['slug' => 'privacy-policy']) }}">
                                    @csrf
                                    <div class="container py-3">
                                        ...
                                        <div class="input-group d-flex align-items-center mt-2">
                                            ...
                                            <input id="section_1_thumbnail" style="height: 36px" value="{{data_get($page->sections, 'hero.hero_image' , '')}}" class="form-control" type="text" name="bg_image">
                                        </div>
                        ...
                        <div class="card mt-2">
                            ...
                            <div id="withoutSpacingAccordionTwo" class="collapse" aria-labelledby="headingTwo2" data-bs-parent="#withoutSpacing">
                                <form method="post" action="{{ route('admin.legal.content.update', ['slug' => 'privacy-policy']) }}">
                                    @csrf
                                    <div class="container py-3">
                                        <span class="d-block mt-4">Content:</span>
                                        <textarea id="summernote-0" name="privacy_policy_content" class="form-control summernote mt-2">{{data_get($page->sections, 'content' , '')}}</textarea>
