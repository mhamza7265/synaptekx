                                ...
                                <form method="post" action="{{ route('admin.legal.hero.update', ['slug' => 'privacy-policy']) }}">
                                    ...
                                    <div class="container py-3">
                                        ...
                                        <div class="input-group d-flex align-items-center mt-2">
                                            ...
                                            <input id="section_1_thumbnail" style="height: 36px" value="{{$page->sections['hero']['hero_image'] ?? ''}}" class="form-control" type="text" name="bg_image">
                                        </div>
                            ...
                            <div id="withoutSpacingAccordionTwo" class="collapse" aria-labelledby="headingTwo2" data-bs-parent="#withoutSpacing">
                                <form method="post" action="{{ route('admin.legal.content.update', ['slug' => 'privacy-policy']) }}">
                                    ...
                                    <div class="container py-3">
                                        ...
                                        <textarea id="summernote-0" name="privacy_policy_content" class="form-control summernote mt-2">{{$page->sections['content'] ?? ''}}</textarea>
