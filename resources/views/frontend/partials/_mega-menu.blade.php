<div id="services-menu" data-id="background-white" class="mega-menu w-100 shadow">
    <div class="container p-0">
        <div class="row justify-content-between align-items-baseline">
            <div class="col-4">
                <a href="{{ route('services', ['name' => 'digital']) }}" style="text-decoration: none" class="d-flex justify-content-start align-items-center gap-3">
            ...
            <div class="col-4">
                <a href="{{ route('services', ['name' => 'security']) }}" style="text-decoration: none" class="d-flex justify-content-start align-items-center gap-3">
        ...
        <div class="row justify-content-between align-items-baseline mt-5">
            <div class="col-4">
                <a href="{{ route('services', ['name' => 'cloud']) }}" style="text-decoration: none" class="d-flex justify-content-start align-items-center gap-3">
            ...
            <div class="col-4">
                <a href="{{ route('services', ['name' => 'managed-services']) }}" style="text-decoration: none" class="d-flex justify-content-start align-items-center gap-3">
            ...
            <div class="col-4">
                <a href="{{ route('services', ['name' => 'talent-acquisition-and-sourcing']) }}" style="text-decoration: none" class="d-flex justify-content-start align-items-center gap-3">
