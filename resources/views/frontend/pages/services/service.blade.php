            ...
            <div class="container services-hero-container">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="services-hero-text-content" data-aos="fade-left" data-aos-duration="500" data-aos-easing="ease-in-out">
                        @php
                            $rawTitle = $service->sections['hero_section']['hero_title'] ?? '';
                        ...
                        <p class="services-hero-subtitle text-white text-center fs-18">{{$service->sections['hero_section']['hero_subtitle'] ?? ''}}</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="nav-content">
            <section class="nav-section">
                <div class="section-navbar d-flex justify-content-between align-items-center px-5 py-4 overflow-x-auto white-space-nowrap">
                    @foreach ($service->sections['all'] as $section)
                        <a href="#{{\Illuminate\Support\Str::Slug($section['display_title'])}}" id="empower-link" class="d-block page-nav-link fs-16 fw-600 text-center me-5 me-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="{{$loop->index}}00">{{$section['display_title']}}</a>
                    @endforeach
                </div>
            </section>
            @foreach ($service->sections['all'] as $section)
                @if ($section['type'] == 'repeating' && $section['group'] == 'features')
                    <section id="{{\Illuminate\Support\Str::Slug($section['display_title'])}}" class="empowering-section bg-white position-relative">
                            ...
                            <div class="row justify-content-between align-items-start">
                                ...
                                <div class="col-12 col-lg-6 empower-right-texts-parent mx-auto mt-4 mt-md-0">
                                    @foreach ($section['data']['details'] as $detail)
                                        <div class="empower-right-texts" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="{{$loop->index}}00">
                                            <h5 class="fs-22 fw-500">{{$detail['detail_title']}}</h5>
            ...
            @foreach ($service->sections['all'] as $section)
                @if ($section['type'] == 'single' && $section['group'] == 'transform')
                    <section id="{{\Illuminate\Support\Str::Slug($section['display_title'])}}" class="transformation-journey-section py-110 bg-white py-5 py-md-0">
                        <div class="container">
                            @php
                            ...
                            <div class="home_graphic mt-5" data-aos="zoom-in" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-center">
                                ...
                                <video autoplay loop muted playsinline class="w-100">
                                    <source src="{{$section['data']['infograph'] ?? ''}}" type="video/mp4">
            ...
            @foreach ($service->sections['all'] as $section)
                @if ($section['type'] == 'repeating' && $section['group'] == 'repeating_blocks')
                    @if ($loop->odd)
                        <section id="{{\Illuminate\Support\Str::Slug($section['display_title'])}}" class="consulting-section py-110 bg-site-grey services-section-bg-grad">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5 mx-auto" data-aos="fade-right" data-aos-duration="500" data-aos-easing="ease-in-out">
                                        <div class="services-section-image">
                                            <img src="{{$section['data']['image'] ?? ''}}" alt="" class="services-section-img" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-7 ps-md-5 mx-auto mt-4 mt-md-0" data-aos="fade-left" data-aos-duration="500" data-aos-easing="ease-in-out">
                                        <h1 class="services-section-title text-gradient mb-4 text-center text-md-start">{{$section['title']}}
                    ...
                    @elseif ($loop->even)
                    <section id="{{\Illuminate\Support\Str::Slug($section['display_title'])}}" class="transformation-section py-110 bg-white">
                        <div class="container overflow-hidden">
                            <div class="row">
                                <div class="col-12 col-lg-7 mx-auto" data-aos="fade-right" data-aos-duration="500" data-aos-easing="ease-in-out">
                                    <div class="d-flex justify-content-start align-items-center mb-4">
                                        ...
                                        <h1 class="services-section-title text-gradient text-center text-md-start">{{$section['title']}}</h1>
                                    </div>
                                    <div>
                                        {!!$section['data']['description'] ?? ''!!}
                                    </div>
