        ...
        <section class="nav-content">
            <section class="nav-section px-5">
                <div class="d-block d-lg-flex justify-content-between align-items-center px-5 py-5">
                    <a href="#empower" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out">About Synaptekx</a>
                    <a href="#transformation-journey" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="100">Our Unique Approach</a>
                    <a href="#consulting" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="200">Our Mission</a>
                    <a href="#transformation" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="300">Why SynaptekX</a>
                    <a href="#business" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="400">Looking Ahead</a>
                    <a href="#ecommerce" class="d-block page-nav-link fs-16 fw-600 text-center mb-3 mb-lg-0" data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-delay="500">Join Us</a>
                </div>
            </section>
